...
class JaxTableSeeder extends Seeder
{
    private $permissions = [
        [
    ...
    private function createPermission()
    {
        ...
        foreach ($this->permissions as $permission) {
            $permission['guard_name'] = config('jax.super_admin.guard');
    ...
    private function createRole()
    {
        ...
        Role::create([
            'name' => 'admin',
            'guard_name' => config('jax.super_admin.guard')
        ]);
    }
